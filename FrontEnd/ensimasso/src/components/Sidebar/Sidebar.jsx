...
const Sidebar = ({ setActiveComponent }) => {
  ...
  // Définition du tableau de navigation en fonction du rôle de l'utilisateur
  const navigation = [
    {
      name: 'Profile',
      icon: (
    ...
    {
      name: user?.role === 'ASSO' ? 'Gallery' : 'Historique',
      icon: (
        // Exemple d'icône pour Gallery (vous pouvez personnaliser)
