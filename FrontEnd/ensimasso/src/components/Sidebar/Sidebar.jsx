...
const Sidebar = ({ setActiveComponent }) => {
    ...
    return (
        <>
            <nav
                className="top-0 left-0 w-1 h-full border-r bg-white space-y-8 sm:w-80">
                        ...
                        <ul className="px-4 text-sm font-medium flex-1 mt-36">
                            {
                                navigation.map((item, idx) => (
                                    <li key={idx}>
                                        <button onClick={() => setActiveComponent(item.name.toLowerCase())} className="flex items-center gap-x-6 text-gray-600 p-2 rounded-lg  hover:bg-gray-50 active:bg-gray-100 duration-150 mt-6">
